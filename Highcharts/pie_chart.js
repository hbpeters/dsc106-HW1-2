...
var years = [];
var men_enrolled = [];
var this_year = enrollment[enrollment.length-1];

var male_enrollment = parseFloat(this_year["fulltime_men_enrolled"].replace(/,/g, ''));
var female_enrollment = parseFloat(this_year["fulltime_women_enrolled"].replace(/,/g, ''));
...
Highcharts.chart(someVar, {
    ...
    title: {
        text: '2005 UCSD Enrollment by Gender'   
    },
